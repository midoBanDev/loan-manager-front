...
interface SidemenuProps {
  onMenuClick: (componentKey: string) => void;
}

export const Sidemenu = ({ onMenuClick }: SidemenuProps) => {
        ...
        <nav className="flex-1 p-4 space-y-1 overflow-y-auto">
          ...
          <div>
            ...
            {!isSidebarCollapsed && activeMenu === 'person' && (
              <div className="ml-4 mt-1 space-y-1">
                <button
                  onClick={() => onMenuClick('person/create')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  고객 등록
                </button>
                <button
                  onClick={() => onMenuClick('person/list')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  고객 목록
                </button>
          ...
          <div>
            ...
            {!isSidebarCollapsed && activeMenu === 'apply' && (
              <div className="ml-4 mt-1 space-y-1">
                <button
                  onClick={() => onMenuClick('apply/create')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  신청서 등록
                </button>
                <button
                  onClick={() => onMenuClick('apply/list')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  신청서 목록
                </button>
                <button
                  onClick={() => onMenuClick('apply/attachlist')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  첨부파일 목록
                </button>
          ...
          <div>
            ...
            {!isSidebarCollapsed && activeMenu === 'loan' && (
              <div className="ml-4 mt-1 space-y-1">
                <button
                  onClick={() => onMenuClick('loan/list')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  계약 리스트
                </button>
                <button
                  onClick={() => onMenuClick('loan/overdue')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  연체 리스트
                </button>
                <button
                  onClick={() => onMenuClick('loan/deposit')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  입금 리스트
                </button>
          ...
          <div>
            ...
            {!isSidebarCollapsed && activeMenu === 'sms' && (
              <div className="ml-4 mt-1 space-y-1">
                <button
                  onClick={() => onMenuClick('sms/sendlist')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  SMS 발송 리스트
                </button>
                <button
                  onClick={() => onMenuClick('sms/messagemanage')}
                  className="w-full flex items-center px-3 py-2 text-sm text-gray-700 dark:text-gray-200 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700"
                >
                  SMS 메시지 관리
                </button>
